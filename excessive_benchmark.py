...
def benchmark(
    ...
    """Benchmark function that dispatches to the appropriate benchmark function."""
    ...
    # Known multiple-choice datasets
    ...
    if benchmark_arguments.dataset in multiple_choice_datasets:
        return accurate_benchmark(model, tokenizer, benchmark_arguments, generation_config, seed)
    else:
        # We need to update original_benchmark to accept and use our generation_strategy
...
def accurate_benchmark(
    ...
    # Create the appropriate generation strategy
    if generation_config.generation_strategy == "autoregressive":
        generation_strategy: GenerationStrategy = AutoRegressiveGenerationStrategy()
    elif generation_config.generation_strategy == "self_speculative":
        generation_strategy: GenerationStrategy = SelfSpeculativeGenerationStrategy()
